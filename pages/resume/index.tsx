  ...
  return (
    <div className="w-full h-full max-w-3xl p-4">
      <Head>
        ...
        <meta
          name="description"
          content={"Jeremiah Howden's Resume"}
        />
        <meta
          property="og:type"
          content="website"
        ...
        <meta
          property="og:title"
          content={"Jeremiah's Resume"}
        />
        <meta
          property="og:description"
          content={"Jeremiah Howden's resume and portfolio site."}
        />
        <meta
              ...
              <div className="flex flex-col gap-y-6 md:gap-y-4">
                <div className="flex flex-col gap-y-2 md:gap-y-1">
                  ...
                  <div>
                    ...
                    <ul className="ml-4 text-sm text-gray-800 list-disc dark:text-gray-200">
                      <li>
                        Developing mobile and responsive applications for the operations
                        optimization team.
                      </li>
                      <li>
                        Facilitate user requirements and business objectives with direct user
                        contact and field experience.
                      </li>
                    </ul>
                  </div>
                  <div className="ml-0 md:ml-4">
                    ...
                    <ul className="ml-4 text-sm text-gray-700 list-disc dark:text-gray-300">
                      <li>
                        Internal application for field engineers to optimize and automate oil and
                        gas production built with React, Redux, and Material UI.
                      </li>
                      <li>
                        Designed and created mobile application version of iPowerLift, onboarding
                        300+ users including 80+ new users.
                      </li>
                      <li>
                ...
                <div className="flex flex-col gap-y-2 md:gap-y-1">
                  ...
                  <div className="ml-0 md:ml-4">
                    ...
                    <ul className="ml-4 text-sm text-gray-700 list-disc dark:text-gray-300">
                      <li>
                        Internal application built on React and Flask that monitors client domains
                        for phishing attacks.
                      </li>
                      <li>
                        Produced front-end MVP, mentored UCSB capstone team in React to continue
                        with risk analysis.
                      </li>
                    </ul>
                  </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-y-2 md:gap-y-1">
                ...
                <div className="ml-0 md:ml-4">
                  ...
                  <ul className="ml-4 text-sm text-gray-700 list-disc dark:text-gray-300">
                    <li>
                      University capstone project using React Native, Expo, and Firebase in a team
                      of five with full software design specification.
                    </li>
