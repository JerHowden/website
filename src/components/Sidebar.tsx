      ...
      <div className="flex transform -rotate-90">
        <Link href={sl.href}>
          <a className="flex self-end px-8 py-2">
            <span
              className={`text-3xl font-semibold tracking-wider text-gray-400 uppercase transition-colors duration-500 text-opacity-90 hover:text-opacity-100 hover:text-${sl.color}-400`}
            >
              {sl.children}
            </span>
          </a>
