      ...
      <div className="flex flex-col items-baseline w-full p-4 justify-items-center">
        ...
        <div className="grid w-full grid-cols-1 gap-4">
          <ProjectEmbed
            ...
            desc={
              <p>
                Internal EOG application for field engineers to track oil wells primarily focusing
                on{' '}
                <a
                  className="p-0 link"
          ...
          <ProjectEmbed
            ...
            desc={
              <p>
                Capstone Project to track food expiration and meal planning. Created with the
                purpose of minimizing food waste and creating recipes from a user&apos;s pantry as a
                remedy. Built with{' '}
                <a
                  className="p-0 link"
          ...
          <ProjectEmbed
            ...
            desc={
              <p>
                This website was the final project for a Human-Computer Interaction class. It
                features an interactive map with clickable buildings and searchable locations by
                name, code, and tags. Built with{' '}
                <a
